...
(function(){
  ...
  function update(){
    ...
    var progress = Math.max(0, Math.min(1, y / h));
    bg.style.transform = 'translateY(' + (progress * 200) + 'px) scale(' + (1 + progress * 0.08) + ')';
    ticking = false;
  }
  function onScroll(){
    if(!ticking){
...
(function(){var L=[["https://cdn.jsdelivr.net/gh/taiesha-crossbeam/crossbeam-web-assets@main/img/logo-white.svg","Crossbeam",24.8,"/what-is-crossbeam/crossbeam-mcp"],["https://cdn.jsdelivr.net/gh/taiesha-crossbeam/crossbeam-web-assets@main/img/mcp-logos/hubspot.svg","HubSpot",30.1,"hubspot"],["https://cdn.jsdelivr.net/gh/taiesha-crossbeam/crossbeam-web-assets@main/img/mcp-logos/salesforce.svg","Salesforce",34.0,"salesforce"],["https://cdn.jsdelivr.net/gh/taiesha-crossbeam/crossbeam-web-assets@main/img/mcp-logos/zoom.svg","Zoom",27.0,"zoom"],["https://cdn.jsdelivr.net/gh/taiesha-crossbeam/crossbeam-web-assets@main/img/mcp-logos/slack.png","Slack",28.7,"slack"],["https://cdn.jsdelivr.net/gh/taiesha-crossbeam/crossbeam-web-assets@main/img/mcp-logos/docusign.svg","DocuSign",25.4,"docusign"],["https://cdn.jsdelivr.net/gh/taiesha-crossbeam/crossbeam-web-assets@main/img/mcp-logos/marketo-marketo-forms.svg","Marketo",23.3,"marketo"],["https://cdn.jsdelivr.net/gh/taiesha-crossbeam/crossbeam-web-assets@main/img/mcp-logos/stripe.svg","Stripe",34.0,"stripe"],["https://cdn.jsdelivr.net/gh/taiesha-crossbeam/crossbeam-web-assets@main/img/mcp-logos/salesloft.svg","Salesloft",26.7,"salesloft"],["https://cdn.jsdelivr.net/gh/taiesha-crossbeam/crossbeam-web-assets@main/img/mcp-logos/snowflake.svg","Snowflake",26.8,"snowflake"],["https://cdn.jsdelivr.net/gh/taiesha-crossbeam/crossbeam-web-assets@main/img/mcp-logos/tableau.svg","Tableau",25.5,"tableau"],["https://cdn.jsdelivr.net/gh/taiesha-crossbeam/crossbeam-web-assets@main/img/mcp-logos/looker.svg","Looker",29.2,"looker"],["https://cdn.jsdelivr.net/gh/taiesha-crossbeam/crossbeam-web-assets@main/img/mcp-logos/zapier.svg","Zapier",29.5,"zapier"],["https://cdn.jsdelivr.net/gh/taiesha-crossbeam/crossbeam-web-assets@main/img/mcp-logos/netsuite.svg","NetSuite",10.4,"netsuite"],["https://cdn.jsdelivr.net/gh/taiesha-crossbeam/crossbeam-web-assets@main/img/mcp-logos/mailchimp.png","Mailchimp",29.8,"mailchimp"],["https://cdn.jsdelivr.net/gh/taiesha-crossbeam/crossbeam-web-assets@main/img/mcp-logos/microsoft.svg","Power BI",26.1,"power-bi"],["https://cdn.jsdelivr.net/gh/taiesha-crossbeam/crossbeam-web-assets@main/img/mcp-logos/dbt.svg","dbt",34.0,"dbt"],["https://cdn.jsdelivr.net/gh/taiesha-crossbeam/crossbeam-web-assets@main/img/mcp-logos/intercom.svg","Intercom",27.1,"intercom"],["https://cdn.jsdelivr.net/gh/taiesha-crossbeam/crossbeam-web-assets@main/img/mcp-logos/gong.svg","Gong",33.5,"gong"]],t=document.getElementById('mqTrack');if(!t)return;function row(){L.forEach(function(o){var s=document.createElement(o[3]?'a':'span');s.className='mm-marquee-item';if(o[3]){s.href=o[3].charAt(0)==='/'?o[3]:'/partner-mcps/'+o[3];s.title=o[1];}var i=document.createElement('img');i.src=o[0];i.alt=o[1];i.decoding='async';i.style.height=o[2]+'px';s.appendChild(i);t.appendChild(s);});}row();row();})();
